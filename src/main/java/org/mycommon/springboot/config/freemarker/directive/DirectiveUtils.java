...
public class DirectiveUtils {
	...
	static OverrideDirective.TemplateDirectiveBodyOverrideWraper getOverrideBody(Environment env, String name) throws TemplateModelException {
		OverrideDirective.TemplateDirectiveBodyOverrideWraper value = (OverrideDirective.TemplateDirectiveBodyOverrideWraper)env.getVariable(DirectiveUtils.getOverrideVariableName(name));
		return value;
	}
	
	static void setTopBodyForParentBody(Environment env,
			OverrideDirective.TemplateDirectiveBodyOverrideWraper topBody,
